...
class EditStudent extends React.Component {
  ...
  render() {
    return (
      <>
        <form>
          <input type="text" name="firstName" value={this.state.firstName} onChange={this.editFirstName} />
          <input type="text" name="lastName" value={this.state.lastName} onChange={this.editLastName} />
          <input type="text" name="studentId" value={this.state.studentId} onChange={this.editStudentId} />
          <input type="text" name="age" value={this.state.age} onChange={this.editAge} />
          <input type="text" name="nationality" value={this.state.nationality} onChange={this.editNationality} />
          <input type="text" name="degreeProgramme" value={this.state.degreeProgramme} onChange={this.editDegreeProgramme} />

...
class AppliedStudents extends React.Component {
  ...
  onDelete = (id) => {
    axios.delete(`/api/students/${id}`).then(function () {
              ...
              {this.state.students.map((student, index) => (
                <div key={index} className="student-card">
                  <ul>
                    ...
                    <li>Degree Programme: {student.degreeProgramme}</li>
                    <li>Submitted: {moment(student.createdAt).format("MMMM Do YYYY, h:mm:ss a")}</li>
                  </ul>

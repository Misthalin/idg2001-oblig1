...
const FormSubmittion = function () {
  ...
  return (
    <form onSubmit={submitForm}>
      ...
      <input onChange={(e) => setNationality(e.target.value)} type="text" placeholder="Nationality" />
      <input onChange={(e) => setDegreeProgramme(e.target.value)} type="text" placeholder="Degree programme" />
